...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Modern brand colors inspired by award-winning sites
        brand: {
          50: '#f0f4ff',
          100: '#e0e9ff',
          200: '#c7d6fe',
      ...
      fontFamily: {
        ...
        heading: ['var(--font-space-grotesk)', 'var(--font-poppins)', 'system-ui', 'sans-serif'],
        mono: ['var(--font-jetbrains-mono)', 'ui-monospace', 'SFMono-Regular', 'monospace'],
        display: ['var(--font-clash-display)', 'var(--font-space-grotesk)', 'system-ui', 'sans-serif'],
      },
      fontSize: {
      ...
      backgroundImage: {
        ...
        'gradient-electric': 'linear-gradient(135deg, #06d9f4 0%, #22c55e 100%)',
